...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menCadManPrev = new javax.swing.JMenuItem();
        menRel = new javax.swing.JMenu();
        menRelCli = new javax.swing.JMenuItem();
        menRelServ = new javax.swing.JMenuItem();
        menRelChkLst = new javax.swing.JMenuItem();
        ...
        setTitle("PedroAutoCar - Sistema de gerenciamento de oficina mecânica");
        setResizable(false);
        ...
        desktop.setPreferredSize(new java.awt.Dimension(640, 490));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/work_space/icones/Pedro AutoCar1-1.jpg"))); // NOI18N

        lblData.setFont(new java.awt.Font("Tahoma", 1, 28)); // NOI18N
        ...
        menCadManPrev.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.ALT_DOWN_MASK));
        menCadManPrev.setText("Man. Preventiva");
        menCadManPrev.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menCadManPrevActionPerformed(evt);
            }
        });
        menCad.add(menCadManPrev);
        ...
        menRelChkLst.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L, java.awt.event.InputEvent.ALT_DOWN_MASK));
        menRelChkLst.setText("CheckList");
        menRelChkLst.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menRelChkLstActionPerformed(evt);
            }
        });
        menRel.add(menRelChkLst);
    ...
    private void menRelCliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menRelCliActionPerformed
        ...
        if(confirma == JOptionPane.YES_OPTION){
            ...
            try {
                ...
                JasperPrint print = JasperFillManager.fillReport("C:/Reports/clientesPedro.jasper", null, conexao);
    ...
    private void menRelServActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menRelServActionPerformed
       // gerando um relatório de serviços
        ...
        if(confirma == JOptionPane.YES_OPTION){
            ...
            try {
                // usando a classe JasperPrint para preparar a impressão de um relatório
                JasperPrint print = JasperFillManager.fillReport("C:/Reports/servicosPedro.jasper", null, conexao);
                // a linha abaixo exibe o relatório através da classe Jasper Viewer
                JasperViewer.viewReport(print, false);
    ...
    private void menRelChkLstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menRelChkLstActionPerformed
        // chamando a tela CheckList
        TelaCheckList chklst = new TelaCheckList();
        chklst.setVisible(true);
        desktop.add(chklst);
        
    }//GEN-LAST:event_menRelChkLstActionPerformed
    ...
    private void menCadManPrevActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menCadManPrevActionPerformed
        // chamando a tela ManPrev
        TelaManPrev manPrev = new TelaManPrev();
        manPrev.setVisible(true);
        desktop.add(manPrev);
    }//GEN-LAST:event_menCadManPrevActionPerformed
    ...
    private javax.swing.JMenuItem menCadManPrev;
    private javax.swing.JMenuItem menCadOs;
    public static javax.swing.JMenuItem menCadUsu;
    private javax.swing.JMenu menOpc;
    private javax.swing.JMenuItem menOpcSai;
    public static javax.swing.JMenu menRel;
    private javax.swing.JMenuItem menRelChkLst;
