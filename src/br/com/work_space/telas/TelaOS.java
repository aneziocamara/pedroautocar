...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    // a linha abaixo cria uma variável para armazenar um texto de acordo com o radiobutton selecionado
    private String tipo;
    ...
    private void pesquisar_cliente() {
        String sql = "select idcli as Id, nomecli as Nome, fonecli as Fone, Placa from tbclientes where nomecli like ?";
        try {
    ...
    private void excluir_os() {
        int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza de que deseja excluir a OS?", "Atenção", JOptionPane.YES_NO_OPTION);
    ...
    private void imprimir_os(){
        ...
        if(confirma == JOptionPane.YES_OPTION){
            // imprimindo a OS  com o framework JasperReports
            try {
                // usando a classe HashMap para criar um filtro
                HashMap filtro = new HashMap();
                filtro.put("os", Integer.parseInt(txtOs.getText()));
                // usando a classe JasperPrint para preparar a impressão de um relatório
                JasperPrint print = JasperFillManager.fillReport("C:/Reports/osPedro.jasper", filtro, conexao);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtOs, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        cboOsSit.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Na linha", "Veículo pronto", "Orçamento REPROVADO", "Aguardando Aprovação", "Aguardando peças", "Retorno", " ", " ", " " }));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/work_space/icones/pesquisar.png"))); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtCliPesquisar, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        btnOsAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/work_space/icones/crud-adicionar-1.jpg"))); // NOI18N
        ...
        btnOsPesquisar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/work_space/icones/crud-consultar.jpg"))); // NOI18N
        ...
        btnOsAlterar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/work_space/icones/crud-alterar.jpg"))); // NOI18N
        ...
        btnOsExcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/work_space/icones/crud-apagar.jpg"))); // NOI18N
        ...
        btnOsImprimir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/work_space/icones/print-2.jpg"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnOsImprimir, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnOsAdicionar, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(72, 72, 72))
        );

        setBounds(0, 0, 640, 501);
    ...
    private void rbtOrcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtOrcActionPerformed
        // atribuindo um texto à variável tipo se for selecionado
        tipo = "orçamento";
    ...
    private void btnOsExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsExcluirActionPerformed
        // chamando o método para excluir u,a OS
        excluir_os();
