...
public class TelaManPrev extends javax.swing.JInternalFrame {
    ...
    private void cadastrar_manpre() {
        String sql = "insert into tbmanpre(nome, placa, correia_dentada, correia_alternador, correia_arcond, correia_bomba_dagua, filtro_ar, filtro_comb, troca_oleo, velas, cabo_velas, bico_injetor, obs, idcli) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try {
            ...
            pst.setString(13, txtObs.getText());
            pst.setString(14, txtCodCli.getText());
    ...
    private void pesquisar_id() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                txtObs.setText(rs.getString(15));
                txtCodCli.setText(rs.getString(16));
    ...
    private void alterar_manpre() {
        String sql = "update tbmanpre set nome = ?, placa = ?, correia_dentada = ?, correia_alternador = ?, correia_arcond = ?, correia_bomba_dagua = ?, filtro_ar = ?, filtro_comb = ?, troca_oleo = ?, velas = ?, cabo_velas = ?, bico_injetor = ?, obs = ? where idcli = ?";
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtObs, javax.swing.GroupLayout.PREFERRED_SIZE, 451, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnManPreImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManPreImprimirActionPerformed
        ...
        if(confirma == JOptionPane.YES_OPTION){
            ...
            try {
                ...
                JasperPrint print = JasperFillManager.fillReport("C:/Reports/ManutPrevent.jasper",null, conexao);
